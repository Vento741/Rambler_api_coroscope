    ...
    def _prepare_user_message(self, calendar_data: Dict[str, Any], user_type: str) -> str:
        ...
        if user_type == "free":
            ...
            return (
                ...
                f"ЗАПРЕЩЕНО: Подтверждать задание, отвечать на вопросы, начинать свой ответ с 'я понял', 'Приступаю', 'Сейчас посмотрю' и т.д. и т.п. А также не использовать звёздочки в ответе и форматирование (MARKDOWN, HTML)! \n"
